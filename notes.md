...
-1.MOVE WEB DEV SECTIONS TO HOME,
-2.MAKE HOW LC WORKS PG-(add featured works to)
-3.I STILL CANT FIGURE OUT IF I WOULD PREFER A SINGLE PG, OR MULTIPLE(leaning towards single due to small and starting out content)
-4.IF SINGLE, 'ADD BACK TO TOP COMP'
